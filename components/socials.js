...
export const twitter = (
  <svg className={styles.logo} width="27" height="27"  viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="40" height="40" rx="20" fill="black"/>
    <path className={styles.path}
      fill="#000" d="M8.05854 8.51019L17.3256 20.9387L8 31.0408H10.1L18.2622 22.1937L24.8585 31.0408H32L22.2134 17.9151L30.8915 8.51019H28.7951L21.2768 16.6564L15.2037 8.51019H8.05854ZM11.1463 10.0587H14.428L28.9159 29.4886H25.6341L11.1463 10.0587Z" fill="white"/>
  </svg>
...
export default function Socials() {
  return (
    <div>
      <a target="_blank" href="https://github.com/pizza3">
        {github}
      </a>
      <a target="_blank" href="https://codepen.io/pizza3">
        {codepen}
      </a>
      <a target="_blank" href="https://twitter.com/yugam_">
        {twitter}
      </a>
    </div>
  );
